          ...
          <form role="form" id="quickForm" action="aturan_proses.php" method="post">
            ...
            <div class="form-group row">
              ...
              <select class="form-control select2 col-sm-7" name="id_gejala">
                <?php
                $query="SELECT * from tb_gejala where id_gejala not in (select id_gejala from tb_aturan where id_penyakit='$id_penyakit')";
              ...
              <div class="card-footer">
                ...
                class="btn btn" style="background-color: #a184a8; color:white;" value="Simpan">
                <a href="?hal=aturan" style="border: 2px solid #a184a8;" class="btn btn-default">
                  Batal
                </a>
              </div>
            </form>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  $query="SELECT * from tb_gejala join tb_aturan using(id_gejala) where id_penyakit='$id_penyakit'";
                  $result=$mysqli->query($query);
                  $num_result=$result->num_rows;
                  if ($num_result > 0 ) { 
                    $no=0;
                    while ($data=mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td width="20%">
                          <a class="btn btn-danger" title="Hapus Data" href="aturan_proses.php?hapus=<?php echo $id_aturan;?>" 
